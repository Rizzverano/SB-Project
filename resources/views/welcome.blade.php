        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="flex items-center justify-between flex-wrap gap-4 mb-10">
                ...
                <div class="flex items-center gap-2 bg-white border border-blue-100 rounded-full px-4 py-2 shadow-sm">
                    ...
                    <span class="text-xs font-bold text-blue-700 tracking-wide">FB: @SBHilongos</span>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
                ...
                {{-- ══ LEFT: FACEBOOK EMBED ══ --}}
                <div class="hidden sm:flex bg-white rounded-2xl shadow-md border border-slate-200 overflow-hidden flex-col">
                    ...
                    <div class="flex-1">
                        <iframe
                            ...
                            class="w-full block" height="780" style="border:none; overflow:hidden;" scrolling="yes"
                ...
                <div class="flex flex-col gap-5">
                    ...
                    <div class="relative w-full h-64 sm:h-80 rounded-2xl overflow-hidden shadow-md group">
                        ...
                        <div class="absolute bottom-0 left-0 right-0 p-6">
                            <span
                                class="inline-block bg-green-500/20 border border-green-400/40 text-green-300
